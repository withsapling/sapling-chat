...
export function ChatInput() {
  return html`
    ...
    <div
      class="w-full fixed bottom-0 left-0 right-0 flex flex-col items-center"
    >
      ${ScrollToBottom()}
      <div class="w-full max-w-screen-md mx-auto">
        <div class="w-full bg-background px-4 md:px-0 pb-4">
          <div
            class="w-full flex flex-col rounded-2xl border border-gray-200 @dark:border-gray-800 shadow-sm @dark:shadow-gray-800"
          >
